...
we can use this for our rag project for browser automation
...
skills/opencli-adapter-author/SKILL.md — browser operation + adapter authoring, end-to-end
skills/opencli-autofix/SKILL.md — repair broken adapters
skills/opencli-browser/SKILL.md — browser automation reference
skills/opencli-usage/SKILL.md — command and site reference
skills/smart-search/SKILL.md — capability search
...
Decide the auth strategy — PUBLIC / COOKIE / HEADER / INTERCEPT.
Decode response fields and design output columns.
opencli browser init <site>/<name> → write adapter → opencli browser verify <site>/<name>.
Persist site knowledge to ~/.opencli/sites/<site>/ so the next adapter for the same site is faster.
